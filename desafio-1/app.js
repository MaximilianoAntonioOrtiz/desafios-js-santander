...
de Brasil. Luego, muestra una alerta con el mensaje concatenando la respuesta con el texto: "Estuve en {ciudad}
y me acordé de ti".*/
function pregCiudad() {
    let ciudad = prompt("Nombra una ciudad de Brazil:");
